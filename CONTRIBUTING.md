...
There's a tutorial for creating new descriptors [in the descriptors directory](src/descriptors/README.md) and another tutorial for create value objects [in the values directory](src/values/README.md).
